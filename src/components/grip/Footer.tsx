...
export interface FooterProps extends React.HTMLAttributes<HTMLElement> {
  bibendumSrc?: string | null;
  columns?: FooterColumn[];
  legal?: string[];
  tagline?: string;
}

/** Footer — charte-required: legal, Bibendum "Hello", sitemap columns, copyright. */
export function Footer({
  bibendumSrc = null,
  columns = [],
  legal = ['Mentions légales', 'Confidentialité', 'Cookies', 'Accessibilité'],
  ...
  mchStyle('mch-footer', `
    ...
    .mch-footer__grid{max-width:var(--container-max);margin:0 auto;display:grid;
      grid-template-columns:1.4fr repeat(auto-fit,minmax(120px,1fr));gap:40px;align-items:start;}
    .mch-footer__brand{display:flex;flex-direction:column;gap:16px;}
    .mch-footer__hello{display:flex;align-items:flex-end;gap:14px;}
    .mch-footer__hello img{height:84px;width:auto;}
    ...
    .mch-footer__hellotxt{font-family:var(--font-display);font-weight:900;font-size:1.1rem;color:var(--mch-yellow);text-transform:uppercase;}
    .mch-footer__tag{font-family:var(--font-body);font-size:.875rem;color:var(--text-secondary);max-width:34ch;}
      ...
      <div className="mch-footer__grid">
        <div className="mch-footer__brand">
          <div className="mch-footer__hello">
            {bibendumSrc ? <img src={bibendumSrc} alt="Bibendum dit Hello" /> : null}
